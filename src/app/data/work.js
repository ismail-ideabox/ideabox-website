...
const workDetail = [
  {
    id: 1,
    projectName: "Byco",
    workCardImage: images.bycocardimage,
    metaDescription:
      "Ideabox has been a leading technology partner of BYCO & has implemented multiple web, mobile and offline solutions with end-to-end integration with SAP ERP",
    canonicalTag: "https://ideabox.technology/our-work/Byco",
...
Marketing network supports retail outlets in more than 80 cities all over Pakistan and is an emerging leader in the oil marketing sector of our economy.`,
    implementation: `Ideabox has been a leading technology partner of BYCO Petroleum for the past 7 years now. Oil and gas refineries have complex operations with multiple departments and workflows. Managing these operations can be challenging and time-consuming. 
...
With Ideabox's expertise in customising solutions and integrating them with SAP ERP, BYCO can stay ahead of the competition while focusing on its core business.`,
...
AWS Services`,
  },
  {
    ...
    metaDescription:
      "Ideabox has developed a comprehensive customer facing web application, operations management application & ODOO CRM for Takaful Bazaar",
    canonicalTag: "https://ideabox.technology/our-work/Takaful-Bazaar",
...
Takaful Bazaar is a one-stop shop for fulfilling all your Takaful needs. They offer exclusive auto, health, travel and family Takaful products at affordable prices. With attractive features for our Takaful plans, including 24/7 customer service, extensive claims support, add-on covers, a user-friendly app interface, tailored policy recommendation, and affordable prices, customers can compare and purchase a variety of takaful products based on their needs.`,
    implementation: `Ideabox has developed a comprehensive web application along with customised operations management application for Takaful Bazaar which allows customers to compare and buy insurance policies in various categories, including health insurance, life insurance, motor insurance, travel insurance, and more. The platform is user-friendly and provides customers with the necessary information to make informed decisions about their insurance purchases.
...
ODOO CRM`,
  },
  {
    ...
    metaDescription:
      "Ideabox has developed a completely customised end to end solution for Rently which includes; web & mobile applications, CRM & ERP using cutting edge technologies",
    canonicalTag: "https://ideabox.technology/our-work/Rently",
...
Rently provides both on-demand and pre-scheduled vehicles for any situation, occasion or event.`,
    implementation: `Rently is a car rental service in Pakistan that offers a technology-driven solution to car rental services. The company has transformed the traditional car rental model by leveraging technology to provide a seamless and efficient car rental experience to its customers.
...
SEO Services`,
  },
  {
    ...
    canonicalTag: "https://ideabox.technology/our-work/Zahra-Ebrahim",
...
SEO Services`,
  ...
  {
    id: 5,
    projectName: "Salon Plus",
    workCardImage: images.saloncard,
    metaDescription:
      "SalonPlus software is a comprehensive salon management system that is designed to streamline the operations of any salon, spa, or wellness center",
    canonicalTag: "https://ideabox.technology/our-work/Salon-Plus",
    cardImage: images.salonbanner,
    workLogo: images.salonlogo,
    url: "",
    buttontext: "Salon Plus",
    workInfo: `SalonPlus software is a comprehensive salon management system that is designed to streamline the operations of any salon, spa, or wellness centre. Salon Plus is an Ideabox inhouse product. Our software is highly customizable and can be tailored to fit the unique needs of any salon, whether it is a small boutique salon or a large chain of salons.`,
    implementation: `The SalonPlus software offers a range of features that cover all aspects of salon management, including appointment booking, client management, inventory management, staff management, payroll, and reporting. The software also offers a point of sale system that enables salons to manage transactions and accept payments seamlessly.
...
Azure Services`,
  },
  {
    ...
    metaDescription:
      "Book My Memories is a web app designed to help users capture & preserve their memories. The software offers features that enable users to create personalised photo album",
    canonicalTag: "https://ideabox.technology/our-work/Book-My-Memories",
...
SEO Services`,
  },
  {
    ...
    metaDescription:
      "ZOD is a B2B technology platform designed specifically for independent retailers & makers, ZOD aims to revolutionise the South Asian wholesale purchasing process",
